...
class DataAugmenter:
    def __init__(self, dataset_root):
        ...
        self.augmented_dir = os.path.join(dataset_root, 'test_augmented')
    ...
    def create_output_dirs(self):
        """创建输出目录结构"""
        dirs_to_create = [
            os.path.join(self.augmented_dir, 'images'),
    ...
    def augment_single_image(self, blue_img_path, white_img_path, label_path, 
        ...
        if 'rotation' in augmentation_params:
            ...
            print(f"    旋转中心: {center}, 图像尺寸: {width}x{height}")
        ...
        # 保存蓝光图像
        blue_output_path = os.path.join(self.augmented_dir, 'images', 
    ...
    def get_augmentation_strategies(self):
        ...
        strategies = {
            ...
            # 二元组合
            'rot5_bright_low': {'rotation': 5, 'brightness': 0.85},
            'rot5_bright_high': {'rotation': 5, 'brightness': 1.15},
            'rot_neg5_exp_low': {'rotation': -5, 'exposure': 0.9},
            ...
            # 三元组合
            'rot5_bright_blur': {'rotation': 5, 'brightness': 1.1, 'blur': 1.2},
            'rot_neg5_bright_blur': {'rotation': -5, 'brightness': 0.9, 'blur': 1.2},
            'rot5_exp_blur': {'rotation': 5, 'exposure': 1.05, 'blur': 1.3},
            'bright_exp_blur': {'brightness': 1.1, 'exposure': 1.05, 'blur': 1.2},
    ...
    def get_corresponding_files(self, blue_image_path):
        ...
        # 生成白光图片文件名
        base_name = blue_filename.replace('.jpg', '').split('.rf.')[0]
        import re
        ...
        # 构建文件路径
        white_image_path = os.path.join(self.test_dir, 'images_w', white_filename)
