...
% ==== 参数 ====
\newlength{\sepS}\setlength{\sepS}{0.8pt}   % 小列间距
\newlength{\sepL}\setlength{\sepL}{10pt}    % 大列间距（用于 2↔3 与 6↔7）
\newlength{\sepY}\setlength{\sepY}{3pt}     % 行间距

% 7列 → 总列间距 = 4*sepS + 2*sepL （因 2↔3 与 6↔7 为大间距）
\newlength{\colw}\setlength{\colw}{\dimexpr(\linewidth - 4\sepS - 2\sepL)/7\relax}

% 只按宽度放图，高度自适应
\newcommand{\Img}[1]{%
  \includegraphics[width=\colw,trim=2pt 2pt 2pt 2pt,clip]{#1}%
}

% 一行：传入 7 个不同的文件名；2↔3 与 6↔7 之间用大间距 \sepL
\newcommand{\Row}[7]{%
  \noindent
  \Img{#1}\hspace{\sepS}%
  \Img{#2}\hspace{\sepL}% 2↔3 大间距
  \Img{#3}\hspace{\sepS}%
  \Img{#4}\hspace{\sepS}%
  \Img{#5}\hspace{\sepS}%
  \Img{#6}\hspace{\sepL}% 6↔7 大间距
  \Img{#7}\par
}
...
% ===== 列标题（与上面列宽一致；间距模式 S, L, S, S, S, L）=====
\noindent
\makebox[\colw][c]{\small scan}\hspace{\sepS}%
\makebox[\colw][c]{\small Ground Truth}\hspace{\sepL}%
\makebox[\colw][c]{\small MIDeepSeg}\hspace{\sepS}%
\makebox[\colw][c]{\small DINs}\hspace{\sepS}%
\makebox[\colw][c]{\small 3D RITM}\hspace{\sepS}%
\makebox[\colw][c]{\small VMN}\hspace{\sepL}%
\makebox[\colw][c]{\small SAM\text{-}Med3D}
...
% 7列 → 总列间距 = 4*sepSa + 2*sepLa （因 2↔3 与 6↔7 为大间距）
...
% 一行：传入 7 个不同的文件名；2↔3 与 6↔7 之间用大间距 \sepLa
\newcommand{\Row}[7]{%
  \noindent
  \Img{#1}\hspace{\sepSa}%
...
\makebox[\colwa][c]{\parbox{\colwa}{\centering \small Dual Yolo\\Concat Fusion}}%
\makebox[\colwa][c]{\parbox{\colwa}{\centering \small Dual Yolo\\CrossAttn Fusion}}%
\makebox[\colwa][c]{\parbox{\colwa}{\centering \small Dual Yolo\\(Our Best)}}%
...
\hline
Yolo11-Blue & $\times$ & -- & -- & -- & -- & 96.39 & 0.73$\pm$0.22 & 6.2$\pm$6.6 & 6.9$\pm$4.9\\

Yolo11-White & $\times$ & -- & -- & -- & -- & 96.39 & 0.73$\pm$0.22 & 6.2$\pm$6.6 & 6.9$\pm$4.9\\

Dual Yolo Concat & $\checkmark$ & -- & -- & -- & -- & 90.56 & 0.73$\pm$0.22 & \underline{6.2$\pm$5.1} & \textbf{6.6$\pm$5.1}\\

Dual Yolo Weighted & $\checkmark$ & -- & -- & -- & -- & 11.39 & \textbf{0.77$\pm$0.16} & 7.8$\pm$6.2 & 7.7$\pm$6.8\\

Dual Yolo CrossAttn & $\checkmark$ & -- & -- & -- & -- & \underline{97.50} & 0.73$\pm$0.22 & 6.2$\pm$5.4 & 6.8$\pm$5.1\\
\hline
\textbf{Dual Yolo (Our Best)} & $\checkmark$ & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{97.78} & \underline{0.73$\pm$0.22} & \textbf{6.1$\pm$5.1} & \underline{6.8$\pm$4.9}\\
\hline
...
Method & Dual-backbone & Detection Rate(\%) $\uparrow$ & IOU $\uparrow$ & Diff$_{up}$(px) $\downarrow$ & Diff$_{low}$(px) $\downarrow$ & Detection Rate(\%) $\uparrow$ & IOU $\uparrow$ & Diff$_{up}$(px) $\downarrow$ & Diff$_{low}$(px) $\downarrow$\\
\hline
Yolo11-Blue & $\times$ & -- & -- & -- & -- & 91.67 & 0.73$\pm$0.22 & 6.3$\pm$6.7 & 7.0$\pm$5.0\\

Yolo11-White & $\times$ & -- & -- & -- & -- & 91.67 & 0.73$\pm$0.22 & 6.3$\pm$6.7 & 7.0$\pm$5.0\\

Dual Yolo Concat & $\checkmark$ & -- & -- & -- & -- & 86.11 & 0.73$\pm$0.22 & \underline{6.2$\pm$5.2} & \underline{6.6$\pm$5.2}\\

Dual Yolo Weighted & $\checkmark$ & -- & -- & -- & -- & 9.44 & \textbf{0.77$\pm$0.17} & 41.8$\pm$104.3 & 7.6$\pm$6.5\\

Dual Yolo CrossAttn & $\checkmark$ & -- & -- & -- & -- & \underline{94.72} & \underline{0.74$\pm$0.22} & 6.2$\pm$5.4 & \textbf{6.4$\pm$5.1}\\
\hline
\textbf{Dual Yolo (Our Best)} & $\checkmark$ & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{97.78} & 0.73$\pm$0.22 & \textbf{6.1$\pm$5.1} & 6.8$\pm$4.9\\
\hline
...
Method & Dual-backbone & Detection Rate(\%) $\uparrow$ & IOU $\uparrow$ & Diff$_{up}$(px) $\downarrow$ & Diff$_{low}$(px) $\downarrow$ & Detection Rate(\%) $\uparrow$ & IOU $\uparrow$ & Diff$_{up}$(px) $\downarrow$ & Diff$_{low}$(px) $\downarrow$\\
\hline
Yolo11-Blue & $\times$ & -- & -- & -- & -- & 80.83 & 0.73$\pm$0.23 & 6.3$\pm$6.9 & 7.1$\pm$5.1\\

Yolo11-White & $\times$ & -- & -- & -- & -- & 80.83 & 0.73$\pm$0.23 & 6.3$\pm$6.9 & 7.1$\pm$5.1\\

Dual Yolo Concat & $\checkmark$ & -- & -- & -- & -- & 76.67 & 0.73$\pm$0.22 & \underline{6.1$\pm$5.2} & \underline{6.6$\pm$5.1}\\

Dual Yolo Weighted & $\checkmark$ & -- & -- & -- & -- & 6.39 & \textbf{0.76$\pm$0.17} & 48.8$\pm$114.7 & 7.8$\pm$7.0\\

Dual Yolo CrossAttn & $\checkmark$ & -- & -- & -- & -- & \textbf{86.39} & \underline{0.74$\pm$0.22} & 6.3$\pm$5.5 & \textbf{6.5$\pm$5.0}\\
\hline
\textbf{Dual Yolo (Our Best)} & $\checkmark$ & \textbf{--} & \textbf{--} & \textbf{--} & \textbf{--} & \underline{85.56} & 0.73$\pm$0.22 & \textbf{6.1$\pm$5.1} & 6.9$\pm$5.0\\
\hline
